...
return [
    ...
    // 1.0.0
    'cmsadmin_dashboard_lastupdate' => 'Dernières mises à jour',
    ...
    'cmsadmin_settings_time_title' => 'Programmer',
    'cmsadmin_settings_time_title_from' => 'De',
    'cmsadmin_settings_time_title_till' => 'Jusqu\'a',
    'view_index_page_meta_timestamp_create' => 'Date de création de la page',
    'nav_item_model_error_modulenacd /var   meexists' => 'L\'alias "{alias}" existe déjà en tant que module. Utilisez un d\'alias différent ou renommez le module avec cet alias dans votre configuration.',
    'nav_item_model_error_parentnavidcannotnull' => 'L\'identifiant de la navigation parent ne peut être nul, une erreur s\'est produit lors de l\'extension de la page parent.',
    ...
    'redirect_model_atr_catch_path_hint' => 'Le chemin de redirection. Si vous souhaitez faire correspondre les sous-chemins, utilisez le caractère générique * comme dans /blog*, qui correspondra à chaque sous-chemin de /blog.',
    'redirect_model_atr_catch_path_error' => 'Le chemin doit commencer par un /',
    'redirect_model_atr_redirect_path' => 'Destination',
    'redirect_model_atr_redirect_path_hint' => 'Vous pouvez soit utiliser un chemin absolu commençant par https:// ou http://, un chemin relatif à la racine du site commençant par / ou un chemin relatif au chemin redirigé (par ex. maintenance à rediriger depuis / shop / start à / shop / maintenance).',
    'redirect_model_atr_redirect_status_code' => 'Code HTTP',
